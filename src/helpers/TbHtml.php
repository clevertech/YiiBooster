...
class TbHtml extends CHtml
{
    ...
    static $inputs = array(
        ...
        self::INPUT_NUMBER,
        self::INPUT_PASSWORD,
        self::INPUT_RADIOBUTTON,
        self::INPUT_RANGE,
        self::INPUT_TEXT,
        self::INPUT_TEXTAREA,
        self::INPUT_URL,
        self::INPUT_RADIOBUTTONLIST
    );
    static $dataInputs = array(
        self::INPUT_CHECKBOXLIST,
        self::INPUT_DROPDOWN,
        self::INPUT_LISTBOX,
        self::INPUT_RADIOBUTTONLIST
    ); // Which one requires data
...
EOD;
    ...
    public static function activeTextArea($model, $attribute, $htmlOptions = array())
    {
        ...
        echo self::tag(
            'textarea',
            $htmlOptions,
            isset($htmlOptions['encode']) && !$htmlOptions['encode'] ? $text : self::encode($text)
        );
        echo $help;
        return ob_get_clean();
    }
